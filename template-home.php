          ...
          <div class="container">
            ...
            <div class="catalog__list" id="offers">
              ...
              <?php 
                  ...
                  $offerUr = $url . '&source=ck&promo=' . $seconds;
    ...
    <div class="container">
      ...
      <section class="text">
        <div class="container">
         ...
         <!--  <div class="text__wrapper">
            <h2>Як отримати кредит на карту</h2>
            <p>
              Онлайн кредит — це зручна фінансова послуга, яка дозволяє швидко отримати позику через інтернет, без відвідування банку. Сума кредиту зазвичай становить від 500 до 15 000 гривень, а кошти зараховуються безпосередньо на банківську карту, вказану під час оформлення заявки. Увесь процес подачі заявки відбувається на сайті фінансової компанії із застосуванням сучасних технологій захисту даних. Персональна інформація зберігається виключно у МФО, що гарантує безпеку користування послугами. Для оформлення кредиту необхідні паспортні дані, ідентифікаційний код та мобільний номер телефону. У деяких випадках може знадобитися електронна пошта.
            </p>
            <p>
              Для отримання позики не потрібно підтверджувати рівень доходу, надавати довідку з місця роботи або контакти поручителів. Усі документи оформлюються в електронному вигляді, а кредитний договір і інформація щодо заборгованості доступні в особистому кабінеті. Кошти надходять на карту будь-якого українського банку.

              Повторне оформлення кредиту займає значно менше часу — достатньо подати заявку та дочекатися зарахування коштів. Онлайн кредити доступні цілодобово, незалежно від місця перебування.
            </p>
            <h2>Хто може оформити кредит</h2>
            <p>
              Оформити кредит онлайн можуть громадяни України віком від 18 років. Фінансові компанії розглядають заявки незалежно від форми працевлаштування — офіційна робота не є обов’язковою умовою.

              Такий формат кредитування підходить для покриття термінових або дрібних витрат, наприклад до отримання заробітної плати. Кошти надаються без цільового призначення, тому їх можна використати на побутові потреби, оплату послуг, відпочинок або завершення ремонту.
            </p>
            <h2>Вартість кредиту</h2>
            <p>
              Умови кредитування можуть відрізнятися залежно від фінансової компанії, проте загалом вони знаходяться на схожому рівні. Більшість МФО пропонують вигідну акцію — перший кредит під 0,01%, що дозволяє суттєво зекономити.

              Під безвідсотковим кредитом мається на увазі мінімальна ставка 0,01% на день. Для постійних клієнтів часто діють знижки або пільгові умови.
            </p>
            <p>
              Стандартна процентна ставка зазвичай складає від 1% до 2% на день. При повторному зверненні можна отримати зменшення відсотків до 50%.

              У деяких компаніях передбачена разова комісія за оформлення кредиту, яка включається в загальну суму позики та може сягати до 2%
            </p>
            <ul class="text__calculation">
              <li>
                <strong
                  >Приклад розрахунку вартості кредиту: (сума кредиту* відсоток
                  по кредиту) * термін + тіло кредиту.</strong
                >
              </li>
              <li>
                <strong>Безвідсотковий кредит:</strong> (1000 * 0,01%) * 90 +
                1000; сума до повернення за 3 місяці складе 1009 грн.
              </li>
              <li>
                <strong>Кредит з відсотковою ставкою 1,85%:</strong> (1000 *
                1,85%) * 90 + 1000; сума до повернення за 3 місяці складе 2665
                грн.
              </li>
            </ul>
            <h2>Переваги оформлення кредиту онлайн.</h2>
            <div class="text__advantages-wrapper">
              <ul class="text__advantages text__advantages_fast">
                <li>Швидко</li>
                <li>потрібні лише паспорт та ІПН;</li>
                <li>оформлення без відвідування банку;</li>
                <li>час розгляду заявки — до 15 хвилин;</li>
              </ul>
              <ul class="text__advantages">
                <li>Безпечно</li>
                <li>кошти зараховуються безпосередньо на карту;</li>
                <li>остаточне рішення приймає клієнт;</li>
                <li>підтвердження операцій через особистий телефон;</li>
              </ul>
              <ul class="text__advantages">
                <li>Вигідно</li>
                <li>процентна ставка від 0,01%;</li>
                <li>бонусні програми та акції;</li>
                <li>лояльні умови для постійних клієнтів;</li>
              </ul>
            </div>
            <h2>Наслідки неповернення кредиту.</h2>
            <p>
              Невиконання кредитних зобов’язань може призвести до нарахування штрафів і зниження кредитного рейтингу. У разі прострочення платежу фінансова компанія має право застосувати підвищену процентну ставку як штрафну санкцію.

              Крім того, при повторному зверненні за кредитом, навіть до іншої МФО, можливе отримання відмови або зменшення доступної суми позики. У разі тривалої прострочки компанія може вимагати повного дострокового погашення боргу.

              Разом з тим, більшість фінансових компаній пропонують послугу пролонгації кредиту, яка дозволяє продовжити термін користування позикою. Один і той самий кредит можна пролонгувати декілька разів, сплачуючи лише нараховані відсотки.
            </p>
          </div> -->
        </div>
      </section>
